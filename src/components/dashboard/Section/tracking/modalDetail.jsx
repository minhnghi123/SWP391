              ...
              <div className="bg-gray-50 p-3 rounded-xl">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">
                      {childData?.find(
                        (item) => item.id === selectedRecord.childId
                      )?.name || "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">
                      {selectedRecord?.vaccineName || "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1 text-gray-600">
              ...
              {selectedRecord?.reaction && (
                <div className="bg-gray-50 p-3 rounded-xl">
                  ...
                  <div className="text-sm">
                    {getReactionBadge(selectedRecord.reaction)}
                  </div>
                </div>
              )}
            </div>
              ...
              <div className="bg-gray-50 p-3 rounded-xl h-full">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center justify-between p-2 bg-white rounded-md border border-gray-200">
                    ...
                    <span className="font-medium">
                      {selectedRecord.minimumIntervalDate
                        ? FormatDate(selectedRecord.minimumIntervalDate)
                        : "N/A"}{" "}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-white rounded-md border border-gray-200">
                    ...
                    <span className="font-medium">
                      <span className="font-medium">
                        {selectedRecord.maximumIntervalDate
                          ? FormatDate(selectedRecord.maximumIntervalDate)
                          : "N/A"}{" "}
                      </span>{" "}
                    </span>
                  </div>
