        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-blue-400 text-white px-4 py-2 rounded-full hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 flex items-center gap-2 shadow-lg shadow-indigo-500/20"
            >
              <Plus className="w-5 h-5" />
              New Booking
            </button>
            {bookingForm && (
              <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                <div className="bg-white p-6 rounded-2xl shadow-2xl w-[400px] text-center relative">
                  ...
                  {/* Dùng map để tạo danh sách input */}
                  {["Parent Name", "Details", "Note"].map(
                    (placeholder, index) => (
                      <input
                        key={index}
                        type="text"
