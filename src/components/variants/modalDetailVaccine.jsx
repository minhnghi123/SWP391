            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                        ...
                        <p><span className="font-medium">Status:</span> <span className={`font-semibold ${data.status === "AVAILABLE" ? "text-green-600" : "text-red-600"}`}>{data.status}</span></p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                        <p><span className="font-medium">Min Age:</span> {data.suggestAgeMin} {data.suggestAgeMin < 12 ? "months" : "months"}</p>
                        <p><span className="font-medium">Max Age:</span> {data.suggestAgeMax} {data.suggestAgeMax >= 12 ? "months" : "months"}</p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="col-span-2 bg-green-50 p-4 rounded-lg">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-sm text-gray-600">Status: <span className={`font-semibold ${data.status === "AVAILABLE" ? "text-green-600" : "text-red-600"}`}>{data.status}</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-2 bg-green-50 p-4 rounded-lg">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                            <p className="text-xl font-bold text-green-700">{data.finalPrice?.toLocaleString()} VND</p>
                ...
                <div className="col-span-2">
                    ...
                    <div className="space-y-4">
                        {data.vaccines && data.vaccines.map((vaccine) => (
                            <div key={vaccine.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                                ...
                                <div className="mt-2 grid grid-cols-2 gap-2 text-sm text-gray-600">
                                    <p><span className="font-medium">Age Range:</span> {vaccine.suggestAgeMin}-{vaccine.suggestAgeMax} months</p>
                                    <p><span className="font-medium">From:</span> {vaccine.fromCountry}</p>
                                    <p><span className="font-medium">Interval:</span> {vaccine.minimumIntervalDate}-{vaccine.maximumIntervalDate} days</p>
